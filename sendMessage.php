...
$message_text = scrubIt($message_data->message_text);
debugIt("message_text: " . $message_text);
...
$message_sql .="(`sender_id`,`recipient_id`,`text`)";
$message_sql .= " VALUES ";
$message_sql .= "(".$sender_id.",".$recipient_id.",'".$message_text."');";
